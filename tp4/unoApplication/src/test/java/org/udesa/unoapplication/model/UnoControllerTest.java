...
public class UnoControllerTest {
    ...
    @Test public void testPlayerWrongTurn() throws Exception {
        ...
        assertEquals("Error: " + Player.NotPlayersTurn + "Jorge", resp);
    }



    @Test
    public void testCannotCreateMatchWithDuplicateNames() throws Throwable {
    ...
    @Test
    public void testPlayWithoutCardContent() throws Exception {
        String id = newMatch("Miguel", "Jorge");
    ...
    @Test
    public void testCannotCreateMatchWithNoPlayers() throws Exception {
